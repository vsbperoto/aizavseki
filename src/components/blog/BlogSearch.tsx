    ...
    <div className="relative w-full max-w-2xl mx-auto group">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          aria-label={"\u0422\u044A\u0440\u0441\u0438 \u0432 \u0431\u043B\u043E\u0433\u0430"}
          className="w-full h-14 pl-12 pr-12 bg-brand-navy/80 backdrop-blur-xl text-brand-white placeholder:text-brand-gray/60 border border-brand-white/10 rounded-xl focus:outline-none focus:border-brand-cyan focus:ring-2 focus:ring-brand-cyan/70 transition-all duration-300 font-heading"
        />
